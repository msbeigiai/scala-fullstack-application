...
object Dependencies {
  ...
  val circeGenericExtra = "io.circe" %% "circe-generic-extras" % circeVersion
  val kafka = "com.github.fd4s" %% "fs2-kafka" % fs2KafkaVersion
  val elasticSearchClient = "org.elasticsearch.client" % "elasticsearch-rest-high-level-client" % elasticSearchVersion
}
